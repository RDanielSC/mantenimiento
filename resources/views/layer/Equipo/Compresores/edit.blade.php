...
@section('main-content')
    ...
    {{--------}}
    {!!Form::model($compresores,['route'=>['compresor.update',$compresores->Compresor_ID],'method'=>'PUT']) !!}
    ...
    <div class="box box-default collapsed-box">
        ...
        <div class="box-body">
            ...
            <div class="col-xs-6">
                ...
                {!! form::text('CoDoAñoFab',null,['id'=>'CoDoAñoFab','class'=>'form-control','placeholder'=>'']) !!}
            </div>
            <div class="col-xs-6">
                {!! form::label('Marca') !!}
    ...
    <div class="pull-right">
        ...
        <script>
            ...
            {
                document.location.href = "{{url('compresor')}}";
            })
        </script>
        {!!form::close()!!}
    </div>
