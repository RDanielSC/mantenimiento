...
git
        ...
        <div class="panel-body">
            {!!Form::open(['route'=>'historial.store','method'=>'POST','files'=>true]) !!}
            ...
            <div class="col-xs-12">
                {!! form::label('Orden de Trabajo') !!}
                {!! form::text('OrdenDeTrabajo',null,['id'=>'OrdenDeTrabajo','class'=>'form-control','placeholder'=>'']) !!}
            </div>
            <hr>
                <div class="col-xs-6">
